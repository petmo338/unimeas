...
try:
    from PyDAQmx.DAQmxFunctions import TaskHandle, DAQmxCreateTask, DAQmxCreateDOChan, DAQmxStartTask, DAQmxStopTask, \
        DAQmxWriteDigitalLines, DAQmxClearTask
...
class CallbackTask(Task, HasTraits):
    ...
    def EveryNCallback(self):
        ...
        if self.sample_number_in_cycle == 0:
            ...
            DAQmxWriteDigitalLines(self.DOtaskHandle, 1, 1, 10.0, DAQmx_Val_GroupByChannel, output, byref(read),
                                   POINTER(c_uint32)())
