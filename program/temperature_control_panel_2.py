...
class TemperatureControlPanel(HasTraits):
    ...
    @staticmethod
    def _set_parameters_queue_default():
        return Queue.Queue(2)

    @staticmethod
    def _get_parameters_queue_default():
        return Queue.Queue(2)
    ...
    @staticmethod
    def _available_pid_configurations_default():
